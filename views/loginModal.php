...
<body>
    ...
    bg-cover bg-center before:absolute before:inset-0 before:bg-[#1c4245] before:opacity-50 before:content-[''] z-0 ">
        ...
        <!-- MAINCONTAINER -->
        <div class="flex flex-col space-y-6 bg-white rounded-md my-4 max-w-sm w-full md:mx-auto 
...
?>
                ...
                <div class="flex flex-col gap-4 items-center justify-center">
                    <button class="border border-solid border-[#cccc] py-4 px-8 w-full flex items-center
                         justify-center hover:cursor-not-allowed "><img class="w-9 mr-4"
                            src="../public/img/facebook.png" alt="">
                        <p>Facebook</p>
                    </button>
                    <button class="border border-solid border-[#cccc] py-4 px-8 w-full flex 
                        items-center justify-center hover:cursor-not-allowed"><img class="w-9 mr-4"
                            src="../public/img/google.png" alt="">
                        <p>Google</p>
                    </button>
                </div>
            </div>
