...
<body class="bg-gray-100 text-gray-800">
    ...
    <?php 
        ...
        $list_accomodation = ManagerController::getAccommodation(); //[]
    ?>
        ...
        <nav class="container mx-auto px-4 lg:px-8 py-4">
            <div class="flex flex-wrap justify-between items-center">
                ...
                <div class="hidden lg:flex lg:items-center lg:w-auto" id="desktop-menu">
                    ...
                    <li>
                            <a href="../views/adminView.php" class="block py-2 text-teal-600 border-b-2 border-teal-600 hover:text-teal-800 transition-colors duration-300" aria-current="page">Inicio</a>
                        </li>
                        <li>
                            <a href="../views/register_task.php" class="block py-2 text-white hover:text-teal-400 transition-colors duration-300 nav-link">Registrar alojamiento</a>
                        </li>
    ...
    <div class="container mx-auto px-4 mt-16 mb-8">
        <h2 class="text-3xl font-bold text-gray-800 text-center">HOLA, <?php echo $_SESSION['User']; ?> - VISTA ADMIN</h2>
        <p class="text-gray-600 text-center mt-2 mb-8">Como administrador puedes agregar alojamientos</p>
    </div>

    <div class="container mx-auto p-5">

        <a href="./register_task.php" class="inline-block bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 mb-6">Registrar alojamiento</a>
        ...
        <table class="min-w-full border-collapse border border-gray-300">
                <thead>
                    <tr class="bg-gray-200 text-left">
                        ...
                        <th class="p-3 border border-gray-300">Direccion</th>
                ...
                <tbody>
                    ...
                    <?php foreach($list_accomodation as $item): ?>
                        <tr class="bg-white hover:bg-gray-100">
                            <td class="p-3 border border-gray-300"><?php echo $item['id_lodge']; ?></td>
                            <td class="p-3 border border-gray-300"><img class="h-20 w-full object-cover rounded-full" src="<?php echo $item['URLimage']; ?>" alt="<?php echo $item['name']; ?>">
                            </td>
                            <td class="p-3 border border-gray-300"><?php echo $item['name']; ?></td>
                            <td class="p-3 border border-gray-300"><?php echo $item['address']; ?></td>
                            <td class="p-3 border border-gray-300"><?php echo $item['price']; ?></td>
                            
                            <td class="p-3 border border-gray-300 relative">
                                <!-- Checkbox oculto para controlar el modal -->
                                <input type="checkbox" id="modal-toggle-<?php echo $item['id_lodge']; ?>" class="hidden peer">

                                <!-- Botón Ver más -->
                                <label for="modal-toggle-<?php echo $item['id_lodge']; ?>" 
                                    class="inline-block rounded bg-green-300 px-3 py-1 text-sm text-black font-semibold cursor-pointer hover:bg-green-400 mr-2">
                                    Ver más
                                </label>
