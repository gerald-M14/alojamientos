        ...
        <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-200 ">
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                ...
                <div class="flex items-center lg:order-2">
                    <a href="#" class="text-gray-800 dark:text-black hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-300 focus:outline-none dark:focus:ring-gray-800">Log in</a>
                ...
                <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                    <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        <li>
                            <a href="../views/UserViewMejorado.php" class="block py-2 pr-4 pl-3 text-black rounded bg-primary-700 lg:bg-transparent lg:text-primary-700 lg:p-0 dark:text-black" aria-current="page">Home</a>
                        </li>
                        <li>
            ...
            <div class="relative flex flex-col my-6 bg-white shadow-sm border border-slate-200 rounded-lg w-full sm:w-1/2 md:w-1/3 lg:w-1/4">
                ...
                <div class="p-4">
                    <div class="flex items-center mb-2">
                        ...
                        <span class="ml-2 text-sm font-semibold text-black bg-[#A3E3B1] bg-opacity-10 rounded-full px-2 py-1"><?php echo $item['lodge_type']; ?></span>
                    </div>
                ...
                <div class="px-4 pb-4 pt-0 mt-2 flex gap-2">
                    ...
                    <div class="modal-container fixed inset-0 z-50 overflow-auto">
                        ...
                        <div class="modal-content relative z-10 mx-auto my-10 bg-white rounded-xl shadow-2xl w-11/12 md:w-3/4 lg:w-2/3 max-h-[90vh] overflow-y-auto">
                            ...
                            <div class="sticky top-0 z-20 bg-gradient-to-r from-[#2E3192] to-[#1BFFFF] text-white rounded-t-xl">
                            ...
                            <div class="sticky bottom-0 flex justify-end p-6 border-t bg-white">
                                <div class="flex gap-4">
                                    ...
                                    <button class="px-6 py-2 rounded-lg bg-gradient-to-r from-[#2E3192] to-[#1BFFFF] text-white font-medium hover:shadow-lg transition-all">
