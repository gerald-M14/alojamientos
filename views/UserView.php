...
<head>
    ...
    <style>
        ...
        .hero-section {
            background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.3)), url('https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80');
...
<body class="bg-gray-50 font-sans">
    ...
    <section class="hero-section flex items-center justify-center">
        <div class="container mx-auto px-4 text-center text-white">
            <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">Descubre Lugares Increíbles</h1>
            <p class="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">Encuentra los mejores alojamientos para tu próxima aventura</p>
    ...
    <div class="container mx-auto px-4 mt-16 mb-8">
        <h2 class="text-3xl font-bold text-gray-800 text-center">Alojamientos Destacados</h2>
        <p class="text-gray-600 text-center mt-2 mb-8">Descubre los lugares más populares para tu próxima escapada</p>
    </div>
