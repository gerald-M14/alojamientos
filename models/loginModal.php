         ...
         md:flex-row md:max-w-3xl md:space-y-0 md:pr-0">
            ...
            <div class="flex flex-col space-y-4 p-6">
                ...
                <div class="flex flex-col space-y-4  ">
                    <div class="border border-solid border-[#cccc] py-4 px-4.5"><input type="text"
                ...
                <button class="bg-[#015057] text-white py-4 rounded-md gap-4 flex items-center justify-center">Next <p>
                ...
                <div class="flex flex-col gap-4 items-center justify-center">
                    <button
                        class="border border-solid border-[#cccc] py-4 px-8 w-full flex items-center justify-center "><img
            ...
            <div class="hidden md:flex justify-end w-full relative">
                ...
                <p class="absolute text-4xl -top-4 -right-4 text-[#343434] rounded-[50%] shadow-lg"><i
                        class=" fa-solid fa-circle-xmark "></i></p>
            </div>
        </div>
    </div>
